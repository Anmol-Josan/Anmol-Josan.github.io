...
app.innerHTML = `
<header class="masthead"><a href="#" class="brand" aria-label="Anmol Josan, back to top"><span class="brand-mark" aria-hidden="true">⌖</span> ANMOL JOSAN <span class="muted">/ FLIGHT DECK</span></a><nav class="mast-nav" aria-label="Primary navigation"><a href="#explorer">EXPLORE</a><a href="#records">FLIGHT LOG</a><a href="#source">SOURCE</a></nav><div class="header-right"><span class="status">PORTFOLIO SYSTEM</span><button id="motion" class="quiet" aria-pressed="true">MOTION ON</button></div></header>
<main><section class="intro"><div><p class="eyebrow">ENGINEER · RESEARCHER · BUILDER</p><h1>Ideas into<br><span>measurable impact.</span></h1><p class="intro-copy">Software that saves time. Research that asks better questions.<br> Communities that reach further.</p><a class="intro-cta" href="#explorer">ENTER THE FLIGHT DECK <span>↓</span></a></div><div class="intro-id"><span class="eyebrow">OPERATOR / 001</span><strong>ANMOL<br>JOSAN</strong><span class="small">20 ACTIVITIES & AWARDS<br>5 FIELDS OF EXPLORATION</span><div class="intro-stats"><span><b>3,200+</b> students reached</span><span><b>93%</b> research accuracy</span><span><b>2,000+</b> software users</span></div></div></section>
...
document.querySelector(".source-note")?.setAttribute("id", "source");
